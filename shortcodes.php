...
?>
	...
	<div class="de-video-container full-height no-padding">
        ...
        <video preload="auto" autoplay="" loop="" muted="" poster="<?php echo esc_url($img); ?>" playsinline>
...
function movingbg_func($atts, $content = null){
	...
	<div class="de-video-container full-height no-padding">
		...
		<div class="moving-home" data-time="<?php echo $time1; ?>" style="background-image: url('<?php echo esc_url($img); ?>');"></div>				
	</div>
...
?>
    ...
    <div class="logo-carousel">
        <div class="image__carousel slides project-image-carousel" data-autoplay="<?php echo esc_attr($slideplay); ?>">
            <?php 
            	$img_ids = explode(",",$gallery);
            	foreach( $img_ids AS $img_id ){
            		$meta = wp_prepare_attachment_for_js($img_id);			
